...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-owbxqte.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-owbxqte.containers.anotherwebservice.com/
...
```
git clone git@github.com:Tharun1363/container-owbxqte.git
cd container-owbxqte
```
...
```
docker attach container-owbxqte
```
